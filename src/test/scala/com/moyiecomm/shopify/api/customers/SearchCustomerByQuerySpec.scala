...
class SearchCustomerByQuerySpec extends ApiSpec {
  it should behave like correctShopifyRequestBehaviour(
    apiRequest = SearchCustomerByQuery("Bob+country:United+States"),
    expectedUrl = s"http://localhost:$port/admin/api/2022-01/customers/search.json?query=Bob+country:United+States",
    expectedMethod = Method.GET,
    expectedRequestBody = None,
    mapping = get("/admin/api/2022-01/customers/search.json?query=Bob+country:United+States")
      ...
      .willReturn(
        aResponse()
          ...
          .withBody("""
                      ...
                      |      "created_at": "2022-04-05T13:02:50-04:00",
                      |      "updated_at": "2022-04-05T13:02:50-04:00",
                      |      "first_name": "Bob",
                      |      "last_name": "Norman",
                      |      "orders_count": 1,
                      |      "state": "disabled",
    ...
    expectedResponseBody = Some(
      List(
        Customer(
          ...
          createdAt = "2022-04-05T13:02:50-04:00",
          updatedAt = "2022-04-05T13:02:50-04:00"
        )
      )
    )
  )
