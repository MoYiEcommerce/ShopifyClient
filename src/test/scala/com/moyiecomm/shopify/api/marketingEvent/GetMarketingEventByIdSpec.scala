...
class GetMarketingEventByIdSpec extends ApiSpec {
  it should behave like correctShopifyRequestBehaviour(
    apiRequest = GetMarketingEventById(998730532),
    expectedUrl = s"http://localhost:$port/admin/api/2022-01/marketing_events/998730532.json",
    expectedMethod = Method.GET,
    expectedRequestBody = None,
    mapping = get("/admin/api/2022-01/marketing_events/998730532.json")
