...
class CloseOrderSpec extends ApiSpec {
  it should behave like correctShopifyRequestBehaviour(
    apiRequest = CloseOrder(450789469),
    expectedUrl = s"http://localhost:$port/admin/api/2022-01/orders/450789469/close.json",
    expectedMethod = Method.POST,
    expectedRequestBody = None,
    mapping = post("/admin/api/2022-01/orders/450789469/close.json")
