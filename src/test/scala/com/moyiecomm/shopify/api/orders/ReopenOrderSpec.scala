...
class ReopenOrderSpec extends ApiSpec {
  it should behave like correctShopifyRequestBehaviour(
    apiRequest = ReopenOrder(450789469),
    expectedUrl = s"http://localhost:$port/admin/api/2022-01/orders/450789469/open.json",
    expectedMethod = Method.POST,
    expectedRequestBody = None,
    mapping = post("/admin/api/2022-01/orders/450789469/open.json")
