...
class GetRefundListByOrderIdSpec extends ApiSpec {
  it should behave like correctShopifyRequestBehaviour(
    apiRequest = GetRefundListByOrderId(450789469),
    expectedUrl = s"http://localhost:$port/admin/api/2022-01/orders/450789469/refunds.json",
    expectedMethod = Method.GET,
    expectedRequestBody = None,
    mapping = get("/admin/api/2022-01/orders/450789469/refunds.json")
