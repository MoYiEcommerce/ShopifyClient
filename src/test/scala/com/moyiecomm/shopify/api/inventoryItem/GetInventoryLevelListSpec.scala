...
import com.moyiecomm.shopify.api.inventory.GetInventoryLevelList
import com.moyiecomm.shopify.api.inventory.models.InventoryLevel
import sttp.model.{Method, StatusCode}

class GetInventoryLevelListSpec extends ApiSpec {
  it should behave like correctShopifyRequestBehaviour(
    apiRequest = GetInventoryLevelList(List(808950810, 39072856), List(655441491, 487838322)),
    expectedUrl =
      s"http://localhost:$port/admin/api/2022-01/inventory_levels.json?inventory_item_ids=808950810,39072856&location_ids=655441491,487838322",
    expectedMethod = Method.GET,
    expectedRequestBody = None,
    mapping =
      get("/admin/api/2022-01/inventory_levels.json?inventory_item_ids=808950810,39072856&location_ids=655441491,487838322")
